...
new alignment.Builder(id: 'component-alignment-wildfly-core-74', rule: 'eap-74', reportTitle: '[Olympus]_Wildfly_Core_15.0.x_(EAP_7.4)', logger_project_code: 'olympus-wildfly-core-eap-7.4.x', jobSuffix: 'wildfly-core-74', repoUrl: 'git@github.com:jbossas/wildfly-core-eap.git', branch: '15.0.x', toAddress: EAP_COMP_ALIGMENT_TO_ADDRESS).build(this)
new alignment.Builder(id: 'component-alignment-wildfly-core-73', rule: 'eap-73', reportTitle: '[Olympus]_Wildfly_Core_10.1.x_(EAP_7.3)', logger_project_code: 'olympus-wildfly-core-eap-7.3.x', jobSuffix: 'wildfly-core-73', repoUrl: 'git@github.com:jbossas/wildfly-core-eap.git', branch: '10.1.x', toAddress: EAP_COMP_ALIGMENT_TO_ADDRESS).build(this)
