...
new alignment.Builder(id: 'component-alignment-eap-73', rule: 'eap-73', reportTitle: 'JBoss_EAP_7.3.x', logger_project_code: 'olympus-eap-7.3.x', jobSuffix: 'eap-73', repoUrl: 'git@github.com:jbossas/jboss-eap7.git', branch: '7.3.x', toAddress: EAP_COMP_ALIGMENT_TO_ADDRESS).build(this)
...
new alignment.Builder(id: 'component-alignment-wildfly-core-73', rule: 'eap-73', reportTitle: 'Wildfly_Core_10.1.x_EAP_7.3', logger_project_code: 'olympus-wildfly-core-eap-7.3.x', jobSuffix: 'wildfly-core-73', repoUrl: 'git@github.com:jbossas/wildfly-core-eap.git', branch: '10.1.x', toAddress: EAP_COMP_ALIGMENT_TO_ADDRESS).build(this)
